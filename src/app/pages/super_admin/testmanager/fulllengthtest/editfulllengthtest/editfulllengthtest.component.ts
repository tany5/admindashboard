...
import { EditfulllengthtestService } from './editfulllengthtest.service'
import { ActivatedRoute, Params, Router } from '@angular/router';
import { FormBuilder, FormGroup, Validators } from '@angular/forms';
import { HttpEvent, HttpEventType } from '@angular/common/http';
import { MatSnackBar } from '@angular/material/snack-bar';
@Component({
  selector: 'app-editfulllengthtest',
  templateUrl: './editfulllengthtest.component.html',
  styleUrls: ['./editfulllengthtest.component.scss']
})
export class EditfulllengthtestComponent implements OnInit {
  ...
  duration: any
  remainQuestion: any
  constructor(private service: EditfulllengthtestService, private route: ActivatedRoute, private _formbuilder: FormBuilder, private router: Router, private snackbar: MatSnackBar) {
