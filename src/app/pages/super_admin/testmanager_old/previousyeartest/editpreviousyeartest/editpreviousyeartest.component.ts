...
export class EditpreviousyeartestComponent implements OnInit {
  ...
  constructor(private service: EditpreviousyeartesService, private route: ActivatedRoute, private _formbuilder: FormBuilder, private router: Router, private snackbar: MatSnackBar) { 
